...
* **Cloud:** AWS (S3, EC2, IAM, ElastiCache/Redis)
* **Warehouses:** Snowflake, Amazon Redshift
* **Analytics & BI:** SQL, Python (Pandas, NumPy), Tableau, Power BI
* **Databases:** SQL Server, PostgreSQL
* **ML (Applied Analytics):** Scikit-learn, TensorFlow, PyTorch
...
* Built GTM analytics workflows to analyze pipeline performance, churn, and revenue trends.
* Created leadership-ready datasets for GTM performance tracking and reporting.
* Developed Power BI dashboards to support data-driven go-to-market decisions.
...
* Analyzed customer churn patterns using Python and SQL.
* Built Power BI dashboards highlighting churn drivers and retention metrics.
* Delivered insights to improve targeting and retention strategies.
...
* Built machine learning models to predict airline bird-strike costs.
* Applied feature engineering and model evaluation to support cost-risk assessment.
